			...
			<div class="row">
				...
				<div class="col-sm-6 mt-4 slideanim">
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="needs-validated">
					  ...
					  <div class="form-group">
					    <input type="email" class="form-control contact-box shadow slideanim" id="con-email" name="con-email" placeholder="E-mail Address" required value="<?php echo $_SESSION["uname"];?>">
					  </div>
					  <div class="form-group">
